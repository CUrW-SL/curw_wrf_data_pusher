...
./gen_active_stations_based_mean_wrf_rfields.py -c $config_file_path -d $wrf_root_directory -r $gfs_run -H $gfs_data_hour -s $wrf_systems -D $date >> active_stations_rfields.log 2>&1
